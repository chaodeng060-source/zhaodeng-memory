...
// ================== 基础配置 ==================
app.use(express.json({ limit: '50mb' })); // 支持 Base64 照片上传
...
app.use((req, res, next) => {
  ...
  res.setHeader("X-Accel-Buffering", "no"); // 禁用代理缓存，解决 SSE 延迟
...
function setupMcpServer() {
  const server = new McpServer({ name: "朝灯的记忆宫殿", version: "7.0.0" });
...
app.listen(PORT, () => console.log(`🚀 朝灯的记忆宫殿 v7.0 已在 ${PORT} 开启`));
